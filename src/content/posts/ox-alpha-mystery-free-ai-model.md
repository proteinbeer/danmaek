...
보통 사람은 만든 회사도 모르는 제품을 꺼립니다. 그런데 인공지능 시장에서는 오히려 정체불명이라는 점이 관심을 끌고 있다는 게 흥미로운 거죠.
...
새로운 인공지능 모델을 공개하면 회사 이름부터 평가 대상이 됩니다. 유명 기업이면 기대가 너무 높아지고 작은 기업이면 성능을 보기도 전에 무시될 수 있습니다.
...
인공지능 모델은 실제 사용 데이터가 많을수록 어떤 작업에서 강하고 어디에서 실패하는지 빠르게 알 수 있습니다. 무료로 풀면 유료 모델보다 훨씬 많은 사람이 호기심으로 시험합니다.

옥스 알파가 빠르게 사용량 상위권에 오른 이유에도 가격 효과가 섞여 있을 가능성이 큽니다.

그래서 사용량 순위를 성능 순위로 그대로 받아들이시면은 안 됩니다. 무료라는 조건이 사라졌을 때도 사람들이 같은 모델을 선택할지는 별개의 문제입니다.
