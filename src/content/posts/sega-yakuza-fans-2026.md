---
title: "용과 같이 팬인데 게임은 안 한다, 세가가 이들을 더 중요하게 보는 이유"
description: "세가는 용과 같이 굿즈 구매자의 60%에서 70%가 여성이며, 실제로 게임을 플레이하지 않는 팬도 많다고 밝혔습니다. 플레이 여부와 관계없이 팬을 설정하려는 세가의 전략이 게임 판매와 지식재산 운영에 어떤 변화를 가져오는지 정리했습니다."
date: 2026-09-10
draft: true
updated: 2026-09-10
category: "뉴스"
...
tags:
  ...
  - "굿즈"
  - "지식재산"
image: "/assets/posts/news-images/sega-yakuza-fans-2026-01.jpg"
...
더 흥미로운 건 세가의 태도입니다. 게임을 한 번도 하지 않은 사람도 팬이며 게이머로 본다고 이야기했습니다.

<img class="post-landscape-image post-landscape-image--high" src="/assets/posts/news-images/sega-yakuza-fans-2026-01.jpg" alt="세가의 용과 같이 팬덤 확장 전략을 설명하는 대표 이미지" width="1280" height="720" loading="lazy" decoding="async" />

## 1. 게임을 안 해도 게임 팬이 되는 시대

예전에는 팬덤의 입구가 게임 구매였습니다. 게임을 사고 플레이한 뒤 캐릭터를 좋아하고, 그다음 굿즈나 애니메이션으로 관심이 확장되는 흐름이 일반적이었죠.
...
용과 같이 시리즈가 이런 현상을 보여주기 좋은 이유가 있습니다. 키류 카즈마, 마지마 고로 같은 캐릭터가 게임 플레이 시스템을 넘어 하나의 대중문화 캐릭터처럼 소비되고 있기 때문입니다.

전투를 직접 하지 않아도 컷신과 방송만으로 이야기 흐름을 따라갈 수 있고, 독특한 서브 스토리와 캐릭터 관계만 봐도 즐길 거리가 많습니다. 게임을 하지 않는 팬이 생기기 쉬운 구조죠.
...
세가가 게임을 하지 않은 팬까지 게이머라고 부른 부분은 반응이 갈릴 수 있습니다. 직접 플레이가 없는 사람을 게이머라고 부를 수 있느냐는 오래된 논쟁이 다시 나올 만하죠.

저는 굳이 게이머라는 단어의 자격을 따지는 것보다, 게임 문화가 이미 플레이 화면 바깥으로 훨씬 커졌다는 점이 더 중요하다고 생각합니다. 영화 팬이 모든 영화를 극장에서 보지 않는 것처럼, 게임도 소비 방법이 하나일 필요는 없습니다.
...
이 흐름이 커지면 세가 같은 회사는 더 이상 게임만 만드는 회사라고 부르기 어려워집니다. 캐릭터를 중심으로 영상, 상품, 행사, 협업을 이어가며 하나의 지식재산을 여러 매체에서 굴리는 미디어 회사에 가까워지죠.
