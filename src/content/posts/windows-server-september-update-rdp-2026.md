...
<div class="dan-point">
  <strong>단 포인트</strong>
  <p>윈도우 서버 2019와 2022, 2025에서 9월 누적 업데이트 설치 뒤 원격 데스크톱 서비스가 멈춘다는 관리자 보고가 이어지고 있습니다. 처음에는 정상으로 보이다가 몇 시간 뒤 접속이 끊기고 새 연결도 실패하는 사례가 나왔습니다. 그런데 피해 규모보다 어떤 정보가 새어 나갔고 이후 어떤 연락을 조심해야 하는지가 더 중요해 보이죠.</p>
</div>
