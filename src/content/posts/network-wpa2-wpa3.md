...
WPA3는 비밀번호 추측 공격에 더 강한 인증 방식을 사용하죠. 오래된 노트북과 IoT 기기는 WPA3를 지원하지 않을 수 있습니다.

혼합 모드는 WPA2와 WPA3 기기를 한 네트워크에서 함께 받기 위한 타협입니다. 일부 구형 드라이버는 혼합 모드에서도 연결 오류를 일으킬 수 있죠.
