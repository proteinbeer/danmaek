...
관련 업적은 튜토리얼에서 타르 골렘 체력을 0으로 만들어야 합니다. 새 게임 플러스는 이 튜토리얼을 건너뛰기 때문에 나중에 같은 방식으로 다시 잡을 수 없습니다.
...
느린 일반 공격은 패링 연습에 좋습니다. 성공하면 경직과 반격 기회를 만들 수 있어 제한된 시간 안에 체력을 깎는 데 도움이 됩니다.
...
너무 오래 수비만 하면 전투가 강제로 끝날 수 있습니다. 큰 공격만 확실히 피하고 일반 공격을 패링하면서 꾸준히 피해를 넣는 균형이 중요합니다.
...
전투가 꼬였을 때 메뉴로 나갔다가 다시 시작하는 방식으로 보스 직전에서 재도전할 수 있습니다. 업적 목표라면 초반에 확실히 정리하고 넘어가시는 편이 좋습니다.
