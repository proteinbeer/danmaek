---
title: "타래 언바운드가 한국어로 게임스컴에 나왔다, 한국 게임의 새로운 방향"
...
타래 언바운드는 무너진 육도의 경계 위에서 이야기가 시작됩니다. 여섯 구도자가 윤회의 순환과 관련된 여정을 떠나는 구조라고 하고요.

검과 마법이 등장하는 판타지라는 큰 틀은 익숙하지만 일단 세계를 설명하는 언어가 다릅니다. 윤회와 업, 동양 신화에서 가져온 개념이 설정의 중심에 들어가죠.

해외 유저들에게 모든 단어가 처음부터 익숙할 필요는 없습니다. 오히려 처음 보는 개념이 게임을 기억하게 만드는 장치가 될 수 있거든요.

## 2. 한복과 갓을 숨기지 않은 디자인

공개 영상에서는 한복을 떠올리게 하는 복장과 갓, 도포를 연상시키는 디자인이 등장합니다. 캐릭터가 말하는 언어도 한국어이고요.

한국적인 소재를 사용하면서도 해외 이용자가 알아보기 쉽도록 서양식으로 희석하지 않았습니다. 어디에서 온 디자인인지 분명하게 보여주는 쪽을 택한 셈이죠.

한국 이용자에게는 익숙한 요소지만 세계 시장에서는 오히려 새로운 실루엣이 됩니다. 수많은 중세 갑옷과 로브 사이에서 갓 하나가 더 빨리 기억될 수도 있죠.
...
검은신화 오공의 세계적인 성공 이후 아시아 게임이 자국 문화를 얼마나 드러내야 하는지에 대한 기준도 달라졌습니다. 중국의 건축과 신화, 요괴를 그대로 사용한 것이 약점이 아니라 가장 강한 차별점이 됐거든요.
...
세계관은 낯설지만 게임 방식까지 모두 낯선 것은 아닙니다. 타래 언바운드는 위에서 내려다보는 방식의 액션 게임으로 여러 캐릭터와 기술, 장비를 조합해 적을 상대하는 구조죠.
...
한국적인 디자인을 사용한다고 성공이 보장되는 것은 아닙니다. 처음 관심을 끄는 것은 세계관과 미술이지만 유저를 계속 남게 만드는 것은 전투거든요.

공격이 손에 붙는지, 여러 능력 조합이 실제로 다른 플레이를 만드는지, 보스전이 반복적으로 느껴지지 않는지가 더 오래 가는 평가를 결정합니다.

한국풍이라는 설명이 게임의 가장 큰 장점으로 끝나는 것보다 한국풍이라는 사실을 잊을 정도로 플레이가 재미있는 편이 훨씬 좋은 결과를 가져오죠.

## 6. 한국 게임이 굳이 서양 게임처럼

크래프톤은 이번 게임스컴에서 PUBG 데드넷을 포함해 여러 장르의 작품을 한꺼번에 보여줬습니다. 배틀그라운드 하나의 성공에 의존하는 회사에서 여러 지식재산을 가진 퍼블리셔로 이동하려는 전략이 더 선명해지죠.

타래 언바운드는 그중에서도 한국적인 색을 앞세우는 카드입니다. 이 작품이 좋은 반응을 얻으면 한국 신화와 전통 요소를 사용하는 다른 프로젝트에도 좋은 선례가 될 수 있겠고요.
