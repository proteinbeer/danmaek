...
첫 단계는 가장 단순한 조건부터 확인하는 것입니다. 닌텐도 e숍에서 해당 게임의 스위치 2 에디션 업그레이드 패스를 확인합니다. 이 단계에서 문제가 해결되면 더 큰 설정을 건드릴 필요가 없습니다.
...
특히 기억할 점은 모든 스위치 게임이 스위치 2 에디션을 제공하는 것은 아닙니다. 또 단순 하위 호환 실행과 스위치 2 에디션 업그레이드는 다른 개념입니다. 두 조건을 섞어서 생각하면 정상 동작을 오류로 오해하기 쉽습니다.
