...
첫 단계는 가장 단순한 조건부터 확인하는 것입니다. 스위치 2의 컨트롤러 메뉴에서 잡는 방식과 순서 변경을 엽니다. 이 단계에서 문제가 해결되면 더 큰 설정을 건드릴 필요가 없습니다.
...
특히 기억할 점은 기존 조이콘은 스위치 2 본체에 붙여서 충전할 수 없습니다. 또 조이콘 2 전용 기능이 필요한 게임에서는 기존 조이콘 사용이 제한될 수 있습니다. 두 조건을 섞어서 생각하면 정상 동작을 오류로 오해하기 쉽습니다.
