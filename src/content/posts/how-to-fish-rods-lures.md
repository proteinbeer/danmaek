...
따라서 새 섬에 도착하면 먼저 상점과 현재 퀘스트가 요구하는 미끼를 확인하셔야 합니다. 이전 섬 장비만 고집하면 원하는 어종이 잘 나오지 않을 수 있습니다.
...
초반에는 기본 게 낚싯대처럼 시작 장비로도 충분하지만 뒤로 갈수록 더 강한 생물을 상대하게 됩니다. 이때는 단순히 낚는 것뿐 아니라 끌어올린 뒤 전투까지 고려해야 합니다.
...
진행을 밀 때는 보스 조건과 퀘스트 미끼가 먼저이고, 돈벌이에서는 잡기 쉬운 어종과 트릭샷이 중요하며, 도감에서는 섬별 어종 풀이 중요합니다. 같은 낚싯대와 미끼라도 목적이 달라지면 우선순위가 달라집니다.
