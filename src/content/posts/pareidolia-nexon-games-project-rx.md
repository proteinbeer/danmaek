...
플레이어는 아니마시의 부흥센터 센터장이 되고, 메이츠라 불리는 캐릭터들과 함께 생활하며 도시의 문제를 해결하게 되고요.
...
기존 팬은 원작과 계속 비교하고 새 유저는 굳이 비슷한 게임을 하나 더 시작할 이유가 없고요.
...
대신 얻는 것도 큽니다. 모바일 이용자에게는 접근성을 주고, 피시와 콘솔에서는 더 큰 화면과 높은 그래픽 품질을 보여줄 수 있죠.
