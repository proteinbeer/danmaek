---
title: "게임 그래픽은 2010년에 충분했다, 개발자가 멈추자 한 이유"
description: "시프와 시스템 쇼크 2에 참여했던 개발자 랜디 스미스가 게임 그래픽 경쟁은 2010년 앨런 웨이크 정도에서 멈췄어도 됐다고 말했습니다."
...
랜디 스미스는 그 정도에서 이미 플레이 경험을 전달하기에는 충분한 시각적 충실도를 얻었다고 봅니다.

그 뒤 그래픽은 계속 좋아졌지만 한 세대가 바뀔 때마다 이용자가 느끼는 차이는 줄어들고 제작 비용은 훨씬 크게 늘었습니다.

이른바 수확 체감이 심해진 셈입니다.

## 2. 한 장면을 만드는 사람이 너무 많아졌다

현대 대형 게임은 캐릭터 피부와 머리카락, 재질, 조명, 모션 하나에 전문 인력이 붙습니다.

영화 수준의 컷신과 광대한 오픈월드를 동시에 요구하면서 개발팀 규모와 제작 기간도 계속 커졌습니다.
...
한 회사가 그래픽 투자를 줄였을 때 이용자가 퇴보라고 받아들이면 위험하기 때문입니다.
...
그래픽 제작비가 커지면 게임 가격과 추가 콘텐츠, 개발 기간에도 압력이 생깁니다.

한 작품에 수백명의 인력이 몇 년씩 들어가면 퍼블리셔는 더 많은 판매량과 더 긴 수익 기간을 요구하게 됩니다.

그래서 대형 게임이 안전한 후속작과 익숙한 지식재산에 몰리는 현상도 그래픽 경쟁과 완전히 분리하기 어렵습니다.
