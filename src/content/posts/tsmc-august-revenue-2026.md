...
엔비디아와 AMD는 AI GPU 시장에서 경쟁하고 애플과 퀄컴도 모바일 칩에서 경쟁합니다.
...
지금은 데이터센터용 AI 칩이 엄청난 면적과 수량, 첨단 패키징을 요구하며 투자 방향까지 바꾸고 있습니다.
...
전년 대비 53.3% 증가는 매우 큰 숫자지만 이 성장률이 계속 유지된다고 볼 수는 없습니다.
...
AI 모델 이야기를 보면 소프트웨어가 세상을 바꾸는 것처럼 보이지만 결국 모든 모델은 물리적인 칩 위에서 돌아갑니다.

그 칩을 수백만개 만들어내는 공정이 부족하면 알고리즘 발전도 실제 서비스로 확장되기 어렵습니다.
...
너무 적게 지으면 고객 주문을 놓치고 너무 많이 지으면 수요가 꺾일 때 감가상각 부담이 커집니다.
