---
title: "출시 때 욕먹던 게임이 10년째 무료 업데이트, 노 맨즈 스카이가 살아남은 방법"
description: "노 맨즈 스카이가 출시 10주년을 맞아 코스모스라는 7.0 대형 업데이트를 무료로 배포했습니다. 출시 때 큰 비판을 받았던 게임이 10년간의 무료 업데이트로 신뢰를 회복한 과정과 헬로 게임즈의 운영 방식을 정리했습니다."
date: 2026-09-10
updated: 2026-09-10
category: "뉴스"
subcategory: "게임"
tags:
  ...
  - "무료 업데이트"
  - "코스모스"
image: "/assets/posts/news-images/no-mans-sky-cosmos-update-2026-01.jpg"
imageAlt: "노 맨즈 스카이 코스모스 업데이트를 설명하는 대표 이미지"
imageWidth: 1280
imageHeight: 720
hideHeroImage: true
...
개발사가 2016년 출시 이후 세어온 주요 업데이트만 40개입니다. 시작을 기억하는 사람이라면 지금 모습이 더 믿기 어려울 정도입니다.

<img class="post-landscape-image post-landscape-image--high" src="/assets/posts/news-images/no-mans-sky-cosmos-update-2026-01.jpg" alt="노 맨즈 스카이 코스모스 업데이트를 설명하는 대표 이미지" width="1280" height="720" loading="lazy" decoding="async" />

## 1. 노 맨즈 스카이의 시작은 지금과 정반대였다
...
## 2. 이번 코스모스는 우주를 생활 공간으로 바꾼다

노 맨즈 스카이는 원래 우주 게임이지만 의외로 우주 공간 자체는 오랫동안 큰 변화가 적었습니다. 행성 사이를 이동하는 통로처럼 느껴지는 순간도 많았죠.
...
헬로 게임즈는 10년 동안 그 방식을 밀었습니다. 한두 번의 대형 업데이트로 여론을 돌린 게 아니라, 계속 업데이트가 나오는 상태 자체를 당연하게 만들었죠.

저는 이게 노 맨즈 스카이의 가장 큰 자산이라고 봅니다. 새 기능 하나보다 다음에도 뭔가 더 나올 것이라는 신뢰가 생긴 게임은 쉽게 죽지 않습니다.

## 4. 무료 업데이트가 가능한 이유도 생각해볼 부분

물론 모든 개발사가 같은 방식을 따라 할 수는 없습니다. 10년 동안 큰 무료 업데이트를 만드는 데는 비용이 들고, 기존 판매가 꾸준히 이어져야 합니다.
...
요즘 게임은 출시 첫날 평가가 너무 중요합니다. 동시 접속자가 기대보다 낮거나 리뷰가 나쁘면 며칠 만에 실패작이라는 낙인이 붙곤 하죠.

노 맨즈 스카이는 그 반례입니다. 첫 인상은 매우 나빴지만, 개발사가 서비스를 멈추지 않으면서 평가를 완전히 다시 썼습니다.

그렇다고 모든 실패작이 10년 버티면 살아난다는 뜻은 아닙니다. 중요한 건 시간이 아니라 그 시간 동안 계속 바뀌었다는 점입니다.

저는 그래서 노 맨즈 스카이를 게임 업계의 가장 특이한 성공 사례 중 하나로 봅니다. 잘 출시해서 오래 간 게임이 아니라, 잘못 출시한 뒤 포기하지 않아서 오래 간 게임이기 때문입니다.
