...
인터넷 회선은 보통 비트 단위로 표기하죠. 파일 다운로드 프로그램은 바이트 단위로 보여주는 경우가 많습니다.
...
속도 표시에 Mbps인지 MB인지 단위를 확인합니다. 같은 파일을 여러 서버에서 받아 서버 자체 제한인지 비교합니다. 디스크 쓰기 속도가 다운로드를 따라갈 수 있는지 확인하죠.
