---
title: "알리바바가 주가 하락을 감수하고 102억 달러를 조달한 이유, 인공지능 경쟁은 돈 싸움이 됐다"
...
알리바바가 약 102억 달러 규모의 신주 발행에 나섰습니다. 발표 직후 홍콩 증시에서 주가가 크게 떨어졌지만 회사는 조달 자금을 인공지능, 반도체, 데이터센터에 투입할 계획입니다.
...
## 1. 인공지능은 소프트웨어지만 공장처럼 돈이 든다

기존 인터넷 서비스는 이용자가 늘어도 소프트웨어를 복제하는 비용이 상대적으로 낮았습니다. 반면 생성형 인공지능은 이용자가 질문할 때마다 실제 연산 자원이 들어갑니다.

모델을 학습할 때도 반도체, 전력, 데이터센터가 필요합니다.

서비스가 성공할수록 더 많은 서버를 사야 하고 다음 모델을 만들기 위해 다시 거액을 투자해야 합니다.

인공지능 기업이 소프트웨어 회사이면서 동시에 거대한 기반시설 사업자처럼 움직이는 이유입니다.

알리바바가 102억 달러를 한꺼번에 조달하는 것도 단순한 연구개발비가 아니라 이런 장기 경쟁을 버틸 체력을 확보하는 과정으로 볼 수 있습니다.

## 2. 주가 하락을 감수한 이유

신주 발행 가격은 기존 시장 가격보다 할인돼 정해졌습니다. 기존 주주 입장에서는 회사가 싼 가격에 새 주식을 많이 찍는 것처럼 보일 수 있어 단기적으로 주가에 부담이 됩니다.
...
인공지능 투자의 회수 기간이 길 수 있다는 점을 생각하면 단기 주가보다 장기 투자 여력을 택한 것으로 볼 수 있죠.

주문 규모가 발행 규모를 크게 웃돌았다는 점은 투자자들이 희석을 걱정하면서도 알리바바의 인공지능 전략 자체에는 관심을 갖고 있다는 신호입니다.
...
미국의 대형 기술기업은 막대한 현금 흐름과 최첨단 반도체 접근성을 바탕으로 인공지능 투자를 늘리고 있습니다. 중국 기업은 여기에 반도체 수출 제한이라는 추가 변수까지 안고 있습니다.
...
알리바바가 자체 모델, 클라우드, 반도체를 함께 묶어 투자하려는 이유도 이런 구조와 연결됩니다.

## 4. 모델 순위보다 투자 회수 기간이 중요

인공지능 뉴스는 보통 어떤 모델이 평가에서 1위를 했는지에 집중됩니다. 하지만 기업이 실제로 살아남으려면 성능보다 돈을 벌 수 있는지가 더 중요합니다.
...
## 5. 인공지능 경쟁의 다음 승자는 돈을 오래 버티는 회사

초기 생성형 인공지능 경쟁에서는 놀라운 기능을 먼저 보여주는 회사가 주목받았습니다. 앞으로는 그 기능을 수억 명에게 안정적으로 제공하면서도 돈을 잃지 않는 회사가 더 강해질 가능성이 큽니다.

알리바바의 대규모 자금 조달은 이 변화가 이미 시작됐다는 신호입니다.

102억 달러는 모델 하나를 만드는 비용이라기보다 몇 년 동안 계속 싸울 수 있는 연료에 가깝습니다. 주가가 단기적으로 흔들려도 회사가 이 돈을 실제 성장으로 바꾸면 평가는 달라질 수 있죠.
