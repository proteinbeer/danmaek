---
title: "할리우드는 왜 바이트댄스와 싸우다 합의했을까, 인공지능 저작권 전쟁의 다음 단계"
description: "미국 영화협회와 바이트댄스의 인공지능 저작권 합의 배경과 배우 얼굴 캐릭터 권리 문제 그리고 표준화 논의 방향을 정리합니다."
date: 2026-08-24
updated: 2026-08-24
category: "지식"
tags:
...
미국 영화협회와 바이트댄스가 인공지능 영상, 이미지 생성 도구의 저작권 보호를 강화하기 위한 합의를 맺었습니다. 올해 초까지만 해도 영화협회는 바이트댄스의 시댄스, 시드림과 관련해 저작권 침해 우려를 제기하며 강하게 반발했습니다.
...
## 1. 완전히 막는 것보다 규칙을 만드는 선택

생성형 인공지능 영상은 이미 일반 이용자에게 빠르게 퍼지고 있습니다. 특정 회사 하나를 막아도 비슷한 모델이 다른 곳에서 계속 나올 수 있죠.

영화사 입장에서는 기술 자체를 사라지게 만드는 전략이 현실적이지 않을 수 있습니다.

그래서 더 중요한 건 유명 캐릭터, 배우 얼굴, 영화 장면이 어떤 조건에서 생성될 수 있는지 기준을 만드는 일입니다. 바이트댄스와의 합의도 구체적인 모든 문제를 해결했다기보다 안전장치를 협의하기 시작했다는 의미가 큽니다.

금지보다 통제 가능한 사용으로 방향이 바뀌는 셈입니다.

## 2. 배우 얼굴과 캐릭터는 같은 문제가 아니다

인공지능 저작권 논쟁은 하나의 문제처럼 보이지만 실제로는 여러 권리가 섞여 있습니다. 영화 영상에는 저작권이 있고 캐릭터에는 지식재산권이 있으며 배우의 얼굴과 목소리에는 또 다른 권리 문제가 생길 수 있습니다.
...
## 3. 할리우드가 인공지능을 필요로 할 수도 있는 이유

영화사는 인공지능을 저작권 위협으로만 보는 것이 아닙니다. 제작비 절감, 사전 시각화, 배경 제작, 번역, 후반 작업 등 여러 과정에서 인공지능을 사용할 유인이 있습니다.
...
이렇게 보면 이번 합의는 방어 계약이면서 동시에 향후 사업 모델의 출발점이 될 수도 있습니다.

## 4. 이용자에게는 더 많은 거절이 생길 수 있다

저작권 보호 장치가 강해지면 이용자는 이전에 만들 수 있던 일부 영상을 더 이상 생성하지 못할 수 있습니다. 유명 캐릭터, 배우, 특정 영화 장면을 직접 요구할수록 거절될 가능성이 커질 수 있죠.

서비스 회사 입장에서는 불편한 선택입니다.

생성을 잘 막으면 이용자는 답답해하고 너무 느슨하면 저작권자가 반발합니다. 결국 어느 선에서 막는지가 제품 경쟁력과 법적 위험 사이의 균형 문제가 됩니다.

앞으로 같은 요청을 여러 인공지능 서비스에 넣었을 때 결과보다 허용 범위가 더 크게 달라질 수도 있습니다.

## 5. 다음 단계는 합의보다 표준화

바이트댄스와 미국 영화협회의 합의는 중요한 첫 사례지만 업계 전체의 법은 아닙니다. 다른 인공지능 회사와 다른 저작권자가 같은 기준을 자동으로 따르는 것도 아닙니다.
