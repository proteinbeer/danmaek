...
낚시 방법은 낚시만 오래 하면 끝나는 게임이 아닙니다. 작은 섬에 난파한 뒤 물고기를 잡고, 처치하고, 팔아서 장비를 마련하며 다음 섬으로 이동하는 구조입니다.
...
돈이 급하더라도 고유 전리품은 먼저 퀘스트 용도인지 확인하시는 편이 안전합니다. 일반 물고기로도 돈은 다시 벌 수 있지만 퀘스트 진행을 놓치면 시간을 더 쓰게 됩니다.
...
초반에 가장 많이 막히는 지점은 물고기를 많이 잡았는데 다음 섬이 안 열리는 상황입니다. 이때는 돈이나 낚시 횟수보다 현재 퀘스트와 보스 전리품 반납 여부를 먼저 보셔야 합니다.
