---
title: "윈도우 11 집중 모드, 알림은 남기고 방해만 줄이는 설정 방법"
...
<img class="post-landscape-image" src="/assets/posts/guide-images/hero-bloom.jpg" alt="윈도우 11 집중 기능 설정 화면" width="1280" height="720" loading="lazy" decoding="async" />

## 1. 집중과 방해 금지는 비슷하지만 다르다

방해 금지는 알림 배너와 소리를 조용하게 만드는 기능입니다.
...
둘을 같은 기능으로 생각하면 설정이 헷갈릴 수 있습니다.

알림을 숨기고 싶은 것인지 시간을 정해서 집중하고 싶은 것인지 먼저 정하면 됩니다.
...
반대로 게임 런처, 쇼핑 앱, 일반 알림은 집중 시간에 보이지 않게 만들 수 있죠.
...
윈도우는 특정 상황에서 방해 금지가 자동으로 켜지도록 설정할 수 있습니다.
...
저는 알림을 완전히 끄는 방식보다 필요한 시간에만 조용하게 만드는 쪽이 현실적이라고 봅니다.
...
집중하는 동안 사라진 것이 아니라 뒤로 모여 있는 알림을 정해진 시간에 한꺼번에 처리하면 흐름을 덜 끊을 수 있습니다.
