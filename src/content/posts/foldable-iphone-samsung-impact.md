---
title: "폴더블 아이폰이 나오면 삼성은 위험할까, 갤럭시 Z 폴드에 기회일까"
...
애플의 첫 폴더블 아이폰을 둘러싼 전망이 계속 나오고 있습니다. 아직 애플이 제품 이름과 세부 사양을 공식 발표하지 않았기 때문에 현재 알려진 내용은 전망과 보도를 구분해서 보셔야 하고요.
...
삼성전자는 2019년 첫 갤럭시 폴드를 출시했습니다. 첫 세대는 화면 내구성과 주름, 두께와 무게 등 해결해야 할 문제가 많았고요.

이후 여러 세대를 거치면서 제품은 계속 얇아지고 힌지와 화면 구조도 개선됐습니다. 소비자가 어떤 부분에서 불편을 느끼는지도 실제 판매를 통해 오랫동안 확인했죠.
...
폴더블 스마트폰은 눈에 띄지만 전체 스마트폰 시장에서는 아직 작은 비중을 차지합니다. 일반 스마트폰보다 비싸고 두껍고 무거우며 접히는 화면에 대한 걱정도 남아 있죠.

더 근본적인 문제는 소비자가 굳이 접어야 한다는 겁니다. 화면이 커진다는 장점은 분명하지만 일반 스마트폰보다 많은 돈을 내야 할 만큼 필요한지는 사람마다 다르고요.
...
애플이 새로운 제품 범주에 들어오면 기존에 관심이 없던 소비자도 제품을 보기 시작할 겁니다. 애플 제품을 사지 않는 사람들도 어떤 방식으로 만들었는지 궁금해 하겠고요.
...
폴더블은 화면을 접는 하드웨어만으로는 완성되지 않습니다. 큰 화면에서 두 앱을 동시에 사용하는 방식과 화면을 접었을 때 이어지는 화면 구성, 앱 호환성도 중요하죠.

삼성은 갤럭시 Z 폴드를 여러 세대 운영하면서 소프트웨어 기능까지 쌓아왔습니다. 사양표에는 나타나지 않는 경험들이죠.

애플은 첫 세대에서 이런 부분까지 높은 완성도로 보여줘야 합니다. 늦게 들어오는 대신 첫 제품부터 소비자의 기대치가 매우 높을 수밖에 없고요.

## 5. 애플이 더 잘할 수 있는 부분

반대로 삼성이 안심할 상황도 아닙니다. 애플은 새로운 제품을 늦게 출시하더라도 기존 기술을 그대로 따라가기보다 사용 방식을 다시 정의하는 경우가 많습니다.

아이폰과 아이패드, 맥을 연결하는 생태계도 강점입니다. 접히는 아이폰이 펼쳤을 때 작은 아이패드처럼 자연스럽게 작동한다면 기존 폴더블과 다른 사용 이유를 만들 수 있거든요.
...
카운터포인트리서치는 2026년에도 삼성이 폴더블 시장 1위를 유지할 것으로 전망했습니다. 다만 점유율은 2025년 40%에서 2026년 32%로 내려갈 것으로 예상하고요.
...
삼성은 폴더블을 먼저 만들었습니다. 애플은 훨씬 늦게 들어오죠.

하지만 소비자는 역사보다 현재 제품을 보고 선택합니다. 접었을 때 더 편한지, 펼쳤을 때 무엇을 더 잘할 수 있는지, 높은 가격을 낼 이유가 있는지가 더 중요합니다.

폴더블 아이폰이 등장하면 삼성의 독주가 끝날 수도 있습니다. 동시에 폴더블이 소수의 신기한 스마트폰에서 주류 고급형 제품으로 넘어가는 계기가 될 수도 있다는 점에서 삼성에 무조건 나쁜 뉴스라고 보기는 또 어렵고요.
