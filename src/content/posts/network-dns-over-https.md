...
일반 DNS 질의는 네트워크에서 암호화되지 않는 경우가 많습니다. 공용 와이파이에서 DNS 질의가 노출되거나 변조될 가능성을 줄일 수 있습니다.
...
DNS over HTTPS는 VPN처럼 모든 인터넷 트래픽을 숨기는 기능이 아닙니다. DNS 조회를 암호화하는 기능이므로 보호 범위를 정확히 이해해야 합니다.
