---
title: "크래프톤 신작 WPCA 첫 공개, 서울을 지키는 3인 협동 헌팅 액션"
description: "크래프톤 5민랩이 신작 세계허구관리연맹: WPCA를 소니 스테이트 오브 플레이에서 처음으로 공개했습니다. 현대 서울에서 초자연 현상 '허구'를 사냥하고 격리하는 3인 협동 게임으로, 2028년 글로벌 출시를 목표로 합니다."
date: 2026-09-05
updated: 2026-09-05
category: "뉴스"
subcategory: "게임"
tags:
  ...
  - "협동 액션"
  - "서울"
image: "/assets/posts/news-images/krafton-wpca-01.jpg"
imageAlt: "세계허구관리연맹 WPCA 공개 예고"
imageWidth: 1280
imageHeight: 720
hideHeroImage: true
...
## 1. 소니 무대에서 처음 선을 보인 크래프톤 신작

스테이트 오브 플레이는 소니가 신작을 알리는 데 쓴다고 알려진 무대입니다. 한국 스튜디오의 오리지널 타이틀이 이 자리에 오른 것은 그만큼 글로벌 시장을 겨냥한 목적이 뚜렷하다는 뜻이죠.

트레일러에서는 현대 서울을 배경으로 벌어지는 전투와 다양한 형태의 이상현상, 이를 상대하는 격리자들의 협동 전투가 실제 플레이 화면으로 담겼습니다. 공개 첫 순간부터 한국 이용자에게는 익숙한 대학로와 한강, 빌딩 숲이 게임의 무대가 된 점이 새롭게 다가옵니다.

박문형 5민랩 대표는 "서울을 배경으로 한 어반 판타지 분위기와 경쾌한 액션이 어우러진 게임을 선보일 수 있도록 개발에 집중하고 있다"고 밝혔습니다.

## 2. 현대 서울이 통째로 게임이 되는

중요한 지점은 배경입니다. 이 게임은 인터넷에도 나오지 않는 판타지 대륙이 아니라, 지금의 서울을 그대로 무대로 씁니다. 도시의 일상적인 건물과 거리에서 초자연적 현상이 터지면서 이야기가 시작되죠.
