...
다른 무기를 얻기 전까지 억지로 탐험을 넓힐 필요는 없습니다.
...
머시룸 빌리지 주변에서 예배당 열쇠를 얻은 뒤 슈라인 오브 트라이얼 던전을 끝까지 진행하면 획득합니다. 벽과 바닥 장치가 있어 전투만 보는 던전이 아니라 탐색도 필요합니다.
...
글룸셰이드 그로브 북서쪽에서 마터스 프리즌 던전으로 들어가 진행하면 얻습니다. 특정 방의 적들을 모두 처리해야 무기 방으로 접근할 수 있습니다.
...
사리엘을 따라 체임버 오브 비커밍으로 들어가 최종 전투에서 부활용 무덤 네 개까지 파괴하면 자동으로 획득합니다. 셸 사리엘과 같은 흐름에서 얻게 되므로 둘을 한 번에 정리하기 좋습니다.
