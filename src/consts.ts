...
import toolsCategoryImage from './assets/categories/tools.gif';
...
export const CATEGORIES = [
  ...
  { name: '도구', slug: 'tools', description: '계산기, 변환기, 제너레이터 등 바로 쓸 수 있는 온라인 도구 모음입니다.', image: toolsCategoryImage.src }
] as const;
