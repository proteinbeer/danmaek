...
모든 구매자가 새 확장팩을 사는 것은 아니지만 잠재 고객의 규모는 신작보다 훨씬 뚜렷하죠. 게롤트와 시리, 위쳐 세계관을 설명하는 비용도 줄어들고요.

오래된 게임을 다시 쓰는 가장 큰 이유는 추억보다 이미 형성된 시장입니다.

## 2. 완전한 신작보다 낮은 실패 비용

새로운 대형 게임은 개발 기간이 길고 실패했을 때 손실도 큽니다. 그래픽 기술이 발전할수록 인력, 제작비, 품질 검수의 부담도 함께 올라가니까요.
...
게임 시리즈에서 주인공 교체는 생각보다 큰 위험입니다. 이미 새 주인공에 반감을 산 유저들이 대부분이기도 하고요.
